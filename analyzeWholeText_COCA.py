...
# set up variables
#
output_file_name = "mlp_analysis_coca.csv"
output_file = open(output_file_name, "w")

diff_file_name = "stat_diffs_coca.csv"
diff_file = open(diff_file_name, "w")

print("Output File: " + output_file_name + "\n")

files_juvenile = glob.glob("D:\\corpora\\COCA\\text_fiction_awq\\juvenile\\*.txt")
files_other = glob.glob("D:\\corpora\\COCA\\text_fiction_awq\\other\\*.txt")
sorted_files_juvenile = sorted(files_juvenile)
sorted_files_other = sorted(files_other)
...
# START HERE
#
for file_name in sorted_files_juvenile:
    print("\nAnalyzing: " + file_name)
    group_name = "juvenile_coca"
    #add_ngram_data_group("juvenile_coca")
    analyze_file(file_name, group_name)
    #print_ngram_data(group_name)

for file_name in sorted_files_other:
    print("\nAnalyzing: " + file_name)
    group_name = "other_coca"
    #add_ngram_data_group("other_coca")
    analyze_file(file_name, group_name)
    #print_ngram_data(group_name)

sorted_tags = sorted(all_tags)
stat_writer.output_analysis(sorted_tags)
stat_writer.output_most_significant_differences_between_groups("juvenile_coca", "other_coca", sorted_tags)
output_file.close()
diff_file.close()
